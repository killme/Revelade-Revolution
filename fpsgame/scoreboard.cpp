...
namespace game
{
    ...
    void renderscoreboard(g3d_gui &g, bool firstpass)
    {
        ...
        loopk(numgroups)
        {
            ...
            int bgcolor = sg.team && m_teammode && strcmp(sg.team, "infected") ? (isteam(player1->team, sg.team) ? 0x3030C0 : 0xC03030) : 0,
                fgcolor = 0xFFFF80;
            ...
            if(sg.team && m_teammode)
            {
                ...
                else if (!strcmp(sg.team, "infected")) g.textf("%s", fgcolor, NULL, sg.team);
			...
			if (m_classes)
			{
				g.pushlist();
				g.strut(7);
				g.text("class", fgcolor);
				loopscoregroup(o, g.textf("%s", 0xFFFFDD, NULL, o->infected?"zombie":playerclasses[o->playerclass].name));
				g.poplist();
			}
