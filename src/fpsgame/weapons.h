    ...
    short id; const char *name, *file, *emptyFile; bool scoped, autodown; } weapons[] =
{
    ...
    {   S_KNIFE,                1,      HICON_KNIFE,    550,    0,      14,     198,    50,     1,      0,      0,              PJ_RAY,                         0,      0,      0,      0,      0,      0,      -1,             0.0f,   0.0f,   0.0f,   vec(0,0,0),                     {0, 0, 0, 0 },                                                                          0,
        S_KNIFE,                1,      HICON_KNIFE,    550,    0,      1024,   198,    50,     1,      0,      1,              PJ_PROJECTILE,                  5,      45,     0,      100,    0,      0,      -1,             0.0f,   0.0f,   0.0f,   vec(0,0,0),                     {0, PP_SMOKE_TRAIL_2, 0, PP_SPARK_SPLASH_2 },                                           0,
    ...
    {   S_CBOW,                 0,      HICON_CB,       1500,   25,     2048,   140,    100,    1,      0,      1,              PJ_PROJECTILE,                  4,      800,    0,      0,      0,      0,      DECAL_CRACK,    2.5f,   0.0f,   1.0f,   vec(0,0,0),                     {0, PP_SMOKE_TRAIL_2, 0, PP_SPARK_SPLASH_2 },                                           0,
        S_CBOW,                 0,      HICON_CB,       400,    10,     1024,   140,    50,     1,      0,      2,              PJ_BOUNCER,                     4,      800,   10,     10,      1500,   0,      DECAL_CRACK,    2.5f,   0.0f,   1.0f,   vec(0,0,0),                     {0, PP_SMOKE_TRAIL_2, 0, PP_SPARK_SPLASH_2 },                                           0,
