...
namespace entities
{
	...
	//extern extentity *createentiy(bool local, const vec &o, int type, int v1, int v2, int v3, int v4, int v5, int &idx);
...
namespace game
{
    ...
    extern void physicstrigger(physent *d, bool local, int floorlevel, int waterlevel, int material = 0, int fallvel=0);
