...
static inline clipplanes &getclipplanes(const cube &c, const ivec &o, int size, bool collide, int offset)
{
...
ICOMMAND(attack, "Di", (int *altfire, int *down), {
    game::doattack(*down!=0, *altfire!=0);
});
