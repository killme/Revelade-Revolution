...
struct font
{
    ...
    bool canbedefault; //rr

    font() : name(NULL) {}
    ~font() { DELETEA(name); }
};

#define FONTH (int(curfont->scale * gtextscale))
...
extern void renderbackground(const char *caption = NULL, Texture *mapshot = NULL, Texture *bgshot = NULL, const char *mapname = NULL, const char *mapinfo = NULL, bool restore = false, bool force = false);
