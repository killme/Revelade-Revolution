...
extern void renderbackground(const char *caption = NULL, Texture *bgshot = NULL, const char *mapname = NULL, const char *mapinfo = NULL, bool restore = false, bool force = false);
