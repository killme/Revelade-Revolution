...
static const struct projpartpreset { short type, part, num, fade, radius, gravity; int color; float size; } projpartpresets[PP_NUM] =
{
	...
	{ PT_REGULAR_SPLASH,PART_FJFLAME,		1,	600,	60,		-35,0xFF6633,	10.0f	},	// PP_FLAME_SPLASH_1
	{ PT_REGULAR_SPLASH,PART_FLAME,			8,	100,	50,		-5,	0x906020,	2.6f	},	// PP_FLAME_SPLASH_2
	{ PT_REGULAR_SPLASH,PART_FJFLAME,		1,	600,	60,		-35,0x664CB2,	10.0f	},	// PP_FLAME_SPLASH_3
	...
	const char *name, *file; } weapons[NUMWEAPS] =
{
	...
	{	S_CHAINSAW_ATTACK,	1,	HICON_FIST,		250,	0,		14,		198,	50,		1,		0,		0,			PJ_RAY,					0,	0,		0,	0,	0,		-1,				0.0f,	0.0f,	0.0f,	vec(0,0,0),					{0, 0, 0, 0 },
		S_CHAINSAW_ATTACK,	1,	HICON_FIST,		250,	0,		14,		198,	50,		1,		0,		0,			PJ_RAY,					0,	0,		0,	0,	0,		-1,				0.0f,	0.0f,	0.0f,	vec(0,0,0),					{0, 0, 0, 0 },
		"Chainsaw",			"fist" },
	{	S_SG,				0,	HICON_SG,		1400,	10,		512,	0,	4,		20,		4,		1,			PJ_RAY,					0,	0,		0,	0,	0,		DECAL_BULLET,	2.0f,	30.0f,	1.0f,	vec(0.5f, 0.375f, 0.25f),	{PP_MUZZLE_FLASH_1, PP_STREAK_FLARE_2, 0, 0 },
		S_SG,				0,	HICON_SG,		1600,	70,		512,	0,	40,		1,		2,		2,			PJ_PROJECTILE,			2,	1000,	30,	0,	0,		DECAL_BULLET,	2.0f,	30.0f,	1.0f,	vec(0.2f, 0.1f, 0.1f),		{PP_MUZZLE_FLASH_1, PP_SMOKE_SPLASH_4, 0, PP_EXPLOSION_BLACK },
		"Slugshot",			"shotg" },
	{	S_CG,				0,	HICON_CG,		120,	7,		512,	0,		2,		1,		4,		1,			PJ_PROJECTILE,			0,	0,	0,	0,	0,		DECAL_BULLET,	2.0f,	30.0f,	1.0f,	vec(0.5f, 0.375f, 0.25f),	{PP_MUZZLE_FLASH_6, PP_STREAK_FLARE_3, 0, PP_SPARK_SPLASH_1 },
		S_CG,				0,	HICON_CG,		150,	7,		512,	0,		2,		1,		3,		2,			PJ_PROJECTILE,			0,	0,	0,	0,	0,		DECAL_BULLET,	2.0f,	30.0f,	1.0f,	vec(0.5f, 0.15f, 0.10f),	{PP_MUZZLE_FLASH_6, PP_STREAK_FLARE_4, 0, PP_SPARK_SPLASH_4 },
		"Assault Rifle",	"chaing" },
	{	S_RLFIRE,			0,	HICON_RL,		1800,	125,		1024,	0,	50,     1,		0,		1,			PJ_PROJECTILE,			2,	60,		60,	0,	0,		DECAL_SCORCH,	30.0f,	25.0f,	1.6f,	vec(0.6f, 0.3f, 0.15f),		{PP_MUZZLE_FLASH_2, PP_SMOKE_SPLASH_3, PP_FLAME_SPLASH_2, PP_EXPLOSION_RED },
		S_RLFIRE,			0,	HICON_RL,		2000,	125,		2048,	0,	40,		1,		0,		2,			PJ_PROJECTILE|PJT_HOME,	2,  50,		60,	0,	0,		DECAL_SCORCH,	30.0f,	25.0f,	1.6f,	vec(0.6f, 0.55f, 0.15f),	{PP_MUZZLE_FLASH_2, PP_SMOKE_SPLASH_3, PP_FLAME_SPLASH_2, PP_EXPLOSION_YELLOW },
		"Rocket Launcher",	"rocket" },
	{	S_RIFLE,			0,	HICON_RIFLE,	3000,	30,		2048,	0,	60,		1,		0,		1,			PJ_RAY,					0,	0,		0,	0,	0,		DECAL_BULLET,	3.0f,	25.0f,	1.0f,	vec(0.5f, 0.375f, 0.25f),	{PP_MUZZLE_FLASH_5, PP_SMOKE_TRAIL_1, 0, PP_SPARK_SPLASH_1 },
		S_ITEMHEALTH,		0,	HICON_RIFLE,	250,	0,		2048,	0,	0,		1,		0,		1,			PJ_SPECIAL,				0,	0,		0,	0,	0,		DECAL_BULLET,	3.0f,	25.0f,	1.0f,	vec(0.5f, 0.275f, 0.15f),	{0, 0, 0, 0 },
		"Sniper Rifle",		"rifle" },
	{	S_FLAME,			1,	HICON_FT,		180,	0,		1024,	0,	30,		1,		0,		1,			PJ_FLAME,				0,	11,		30,	-1,	0,		DECAL_SCORCH,	20.0f,	25.0f,	1.0f,	vec(1.f, 0.4f, 0.2f),		{PP_MUZZLE_FLASH_3, PP_FLAME_SPLASH_1, 0, 0 },
		S_FLAME,			1,	HICON_FT,		300,	50,		1024,	0,	0,		1,		0,		2,			PJ_FLAME,				0,	1,		30,	-1,	0,		-1,				20.0f,	25.0f,	1.0f,	vec(0.4f, 0.3f, 0.7f),		{PP_MUZZLE_FLASH_9, PP_FLAME_SPLASH_3, 0, 0 },
		"Flame Jet",		"flameg" },
	{	S_CBOW,				0,	HICON_CB,		2000,	25,		2048,	0,	60, 	1,		0,		1,			PJ_PROJECTILE,			4,	1500,	0,	0,	0,		DECAL_CRACK,	2.5f,	0.0f,	1.0f,	vec(0,0,0),					{0, PP_SMOKE_TRAIL_2, 0, PP_SPARK_SPLASH_2 },
		S_CBOW,				0,	HICON_CB,		1500,	10,		1024,	0,	40,		1,		0,		1,			PJ_PROJECTILE,			4,	1000,		0,	0,	0,		DECAL_CRACK,	2.5f,	0.0f,	1.0f,	vec(0,0,0),					{0, PP_SMOKE_TRAIL_2, 0, PP_SPARK_SPLASH_2 },
		"Lisa",				"cbow" },
	{	S_FLAUNCH,			0,	HICON_GL,		800,	100,		1024,	-1,	70,		1,		0,		1,			PJ_BOUNCER|PJT_TIMED,	1,	300,	50,	0,	1500,	DECAL_SCORCH,	25.0f,	20.0f,	1.6f,	vec(0.25f, 1.0f, 1.0f),		{PP_MUZZLE_FLASH_4, PP_SMOKE_SPLASH_4, 0, PP_EXPLOSION_BLUE },
		S_FLAUNCH,			0,	HICON_GL,		800,	100,		1024,	-1,	60,		1,		0,		1,			PJ_BOUNCER|PJT_STICKY,	1,	300,		30,	0,	0,		DECAL_SCORCH,	25.0f,	20.0f,	1.6f,	vec(0.01f, 0.06f, 0.06f),	{PP_MUZZLE_FLASH_4, PP_SMOKE_SPLASH_4, 0, PP_EXPLOSION_BLUE },
		"Grenadier",		"gl" },
	{	S_ITEMHEALTH,		0,	HICON_HEAL,		800,	0,		1024,	0,	-30,	1,		0,		1,			PJ_RAY,					0,	0,		0,	0,	0,		-1,				0.0f,	0.5f,	1.0f,	vec(0.8f, 0.3f, 0.7f),		{PP_MUZZLE_FLASH_8, PP_HEAL_TRAIL, 0, 0/*PP_SPARK_SPLASH_3*/ },
		S_ITEMHEALTH,		0,	HICON_HEAL,		800,	0,		1024,	0,	60,		1,		0,		1,			PJ_RAY,					0,	0,		0,	0,	0,		-1,				0.0f,	0.5f,	1.0f,	vec(0.8f, 0.3f, 0.7f),		{PP_MUZZLE_FLASH_8, PP_SPARK_TRAIL, 0, 0/*PP_SPARK_SPLASH_3*/ },
		"Healer",			"healer" },
	{	S_FLAUNCH,			0,	HICON_GL,		2200,	30,		4096,	0,	50,		1,		4,		1,			PJ_PROJECTILE,			1,	50,		200,260,0,		DECAL_SCORCH,	50.0f,	40.0f,	4.0f,	vec(0.8f, 0.7f, 0.4f),		{PP_MUZZLE_FLASH_10, 0, 0, PP_EXPLOSION_YELLOW },
		S_FLAUNCH,			0,	HICON_GL,		2200,	30,		4096,	0,	50,		1,		4,		1,			PJ_PROJECTILE,			1,	50,		200,160,0,		DECAL_SCORCH,	50.0f,	40.0f,	4.0f,	vec(0.8f, 0.7f, 0.4f),		{PP_MUZZLE_FLASH_10, 0, 0, PP_EXPLOSION_YELLOW },
		"Mortar",			"mortar" },
	{	S_FLAUNCH,			0,	HICON_GL,		2200,	30,		4096,	0,	50,		1,		4,		1,			PJ_PROJECTILE,			1,	50,		200,260,0,		DECAL_SCORCH,	50.0f,	40.0f,	4.0f,	vec(0.8f, 0.7f, 0.4f),		{PP_MUZZLE_FLASH_10, 0, 0, PP_EXPLOSION_YELLOW },
		S_FLAUNCH,			0,	HICON_GL,		2200,	30,		4096,	0,	50,		1,		4,		1,			PJ_PROJECTILE,			1,	50,		200,160,0,		DECAL_SCORCH,	50.0f,	40.0f,	4.0f,	vec(0.8f, 0.7f, 0.4f),		{PP_MUZZLE_FLASH_10, 0, 0, PP_EXPLOSION_YELLOW },
		"Lisa",				"" },
	{	S_PISTOL,			0,	HICON_PISTOL,	500,	7,		1024,	0,		10,		1,		1,		1,			PJ_RAY,					0,	0,		0,	0,	0,		DECAL_BULLET,	2.0f,	15.0f,	1.0f,	vec(0.5f, 0.375f, 0.25f),	{PP_MUZZLE_FLASH_5, PP_STREAK_FLARE_2, 0, PP_SPARK_SPLASH_1 },
		S_PISTOL,			0,	HICON_PISTOL,	750,	7,		1024,	0,		3,		3,		1,		2,			PJ_RAY,					0,	0,		0,	0,	0,		DECAL_BULLET,	2.0f,	15.0f,	1.0f,	vec(0.5f, 0.375f, 0.25f),	{PP_MUZZLE_FLASH_5, PP_STREAK_FLARE_2, 0, PP_SPARK_SPLASH_1 },
		"Pistol",			"pistol" },
...
{
	// weap[0]				mxhlth		armourtype	armour	mxspd	name
	{ {WEAP_RIFLE_L},		180,		-1,			0,		60,		"HillBilly"},
	{ {WEAP_GRENADIER},		170,		-1,			0,		60,		"DinoMight"},
	//{ {WEAP_MG,		WEAP_ROCKETL},						110,	A_YELLOW,	70,		65,		"Heavy"},
	{ {WEAP_SLUGSHOT},		130,		-1,			0,		65,		"Pom Pom"},
	{ {	WEAP_HEALER},		150,		-1,			0,		58,		"Fix Me"}, // WEAP_BUILD
};
